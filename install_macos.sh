...
# Taken from Kent C. Dodds
# Modified by Stanislas Reltgen
...
# watchman: really handy for watching changes inside files & folders
...
brew cask install alfred google-chrome firefox brave-browser bettertouchtool \
google-drive-file-stream 1password skype \
sublime-text vlc discord obs handbrake zoomus the-unarchiver avibrazil-rdm sip \
qlcolorcode qlmarkdown qlstephen quicklook-json webpquicklook \
suspicious-package qlvideo spotify dropbox slack \
imazing imazing-mini nordvpn \
minecraft steam \
docker
...
echo "creating my RSA token folder"
mkdir -p ~/.ssh

echo "cloning dotfiles"
git clone git@github.com:sreltgen/dotfiles.git "${HOME}/Dev/dotfiles"
ln -s "${HOME}/Dev/dotfiles/.zshrc" "${HOME}/.zshrc"
ln -s "${HOME}/Dev/dotfiles/.gitignore_global" "${HOME}/.gitignore"
ln -s "${HOME}/Dev/dotfiles/.my_bin" "${HOME}/.my_bin"
ln -s "${HOME}/Dev/dotfiles/.aliases" "${HOME}/.aliases"
ln -s "${HOME}/Dev/dotfiles/.bash_profile" "${HOME}/.bash_profile"
ln -s "${HOME}/Dev/dotfiles/.bash_prompt" "${HOME}/.bash_prompt"
ln -s "${HOME}/Dev/dotfiles/.bashrc" "${HOME}/.bashrc"
ln -s "${HOME}/Dev/dotfiles/.curlrc" "${HOME}/.curlrc"
ln -s "${HOME}/Dev/dotfiles/.editorconfig" "${HOME}/.editorconfig"
ln -s "${HOME}/Dev/dotfiles/.exports" "${HOME}/.exports"
ln -s "${HOME}/Dev/dotfiles/.gitconfig" "${HOME}/.gitconfig"
ln -s "${HOME}/Dev/dotfiles/.gvimrc" "${HOME}/.gvimrc"
ln -s "${HOME}/Dev/dotfiles/.inputrc" "${HOME}/.inputrc"
ln -s "${HOME}/Dev/dotfiles/.wgetrc" "${HOME}/.wgetrc"
...
install: \n\
  ...
  PhotoSweeper (App Store) \n \
  Magnet (App Store) \n \
  Wipr (App Store) \n \
  Drafts (App Store) \n \
  Steam (Steam website) \n \
  Transmit (from Panic Museum) \n \
\n\
Restart Terminal.app\n\
copy git config from your backup/re-login \n\
copy ssh config files (config, id_rsa, id_rsa.pub, known_hosts) from your backup/re-login \n\
